...
import { getReviewByProdId, createReview, updateReview, deleteOwnReview, orderReview } from '../controllers/review.controller'
...
reviewRouter.post('/:productId/:orderId/add', authCheck, createReview)
 ...
 *              description: Too many requests  
 */
reviewRouter.put('/:reviewId/update', authCheck, updateReview)
