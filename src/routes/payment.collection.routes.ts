...
import { collectionResponseAdwa, mobilePaymentCollection } from '../controllers/payment.collection.controller'
...
paymentCollectionRoute.post('/:orderId/paymentCollection/mobile', authCheck, mobilePaymentCollection)
