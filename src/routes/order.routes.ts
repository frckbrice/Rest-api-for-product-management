...
import { getOrderById, createOrder, updateOrder, getBuyerOrders, getSellerOrders, getTransaction, updateDispatchDetails } from '../controllers/order.controller'
 ...
 */
orderRouter.post('/new/:productId', createOrder)
...
orderRouter.put('/:orderId/dispatch', uploadMiddleware('dispatchImage'), updateDispatchDetails)
